...
@section('pageHeaderTitle') {{ strToUpper("Student Daily, Weekly, Monthly Fee Setup")}} @endsection
@section('studentDailyFeeSetupPageActive') active @endsection
@section('content')
                ...
                <div class="col-md-12">
                        ...
                        <div class="card d-print-none">
                            ...
                            <div class="card-header">
                                <h4 class="card-title" id="from-actions-multiple">{{ __("STUDENT DAILY, WEEKLY, MONTHLY FEE SETUP") }}</h4>
                                <hr />
                    ...
                    <form class="form" method="post" action="{{route('processDailyFeeSetup')}}">
                    @csrf
                        <div class="card">
                            <div class="card-header">
                                <div class="row">
                                    <div class="col-md-3">
                                        <label> &nbsp; </label>
                                        <h4 class="card-title" id="from-actions-multiple">{{ __("Fee Setup") }}</h4>
                                    </div>
                                    <div class="col-md-9 row d-print-none" style="background: #f9f9f9;">
                                        <div class="col-md-12">
                                            <label> &nbsp; </label>
                                            <div class="buttons-group text-center">
                                                <button type="submit" id="confirmStudentPromotion" class="btn btn-raised btn-primary mr-1">
                                                    <i class="fa fa-users"></i> {{ __('Add and Save') }}
                                                </button>
                                                <input type="submit" name="removeAll" value="Remove All" class="btn btn-raised btn-danger mr-1" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                        ...
                                                        <div class="card-block card-dashboard">
                                                            <table class="table table-hover table-striped table-responsive table-condensed">
                                                                <thead style="font-size:13px;">
                                                                    <tr>
                                                                        <td colspan="8" class="text-center text-uppercase"><h6><strong>{{ $feeName }}</strong></h6></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <th>S/N</th>
                                                                        <th>
                                                                    ...
                                                                    @forelse($allStudentList as $key => $listStudent)
                                                                        @if($listStudent->studentActive == 1)
                                                                            <tr>
                                                                                ...
                                                                                <td>
                                                                                    <label class="containerCheck">
                                                                                        <input id="selectStudentName" value="{{ $listStudent->newStudentID }}" name="studentName[]" type="checkbox" {!! $allSetupStident[$key][$listStudent->newStudentID] ? 'checked="checked"' : '' !!}>   
                                                                                        <span class="checkmark"></span>
                                                                                    </label>
                                                                                </td>
                                                                                ...
                                                                                <td>{!! $allSetupStident[$key][$listStudent->newStudentID] ? '<span class="text-success">Added</span>' : '<span class="text-danger">Removed</span>'  !!}</td>
                                                                            </tr>
                                                                        @else
                                                                        @endif
