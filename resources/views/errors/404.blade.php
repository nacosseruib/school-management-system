...
<main>
 <svg
  ...
  <p id="errorText">O-o-oh! Something broke.</p>
   <p id="errorText">
       <b class="text-danger text-uppercase">Looks like the page you were looking for is no longer here.</b>
   </p>
  <a id="errorLink" href="{{ route('guest') }}" class= "btn btn-danger">Go Back</a>
</main>
</main>
