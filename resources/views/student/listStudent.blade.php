...
@section('pageHeaderTitle') {{ strToUpper(__('All Student List::'. Auth::user()->name)) }} @endsection
                                                        ...
                                                        <table class="table table-hover table-striped table-responsive table-condensed">
                                                            <thead style="font-size:13px;">
                                                                <tr>
                                                                    ...
                                                                    <th class="d-print-none" colspan="3">Actions</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody style="font-size:13px;">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="d-print-none"><a href="{{ route('editStudent', ['studentID' => $listStudent->newStudentID]) }}" class="btn btn-sm btn-secondary" title="Edit Student Information"> <i class="fa fa-edit"></i> </a></td>
                                                                     <td class="d-print-none"><a href="{{ route('printAdmissionLetter', ['studentID' => $listStudent->newStudentID]) }}" title="Print Admission Letter" class="btn btn-sm btn-secondary"> <i class="fa fa-file"></i> </a></td>
                                                                </tr>
