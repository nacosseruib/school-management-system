...
class SubModuleController extends RolePermissionController
{
    ...
    {   
        ...
        $getAllModules = Module::orderBy('module_name', 'Asc')->orderBy('module_rank', 'Asc')->paginate(5);
    ...
    public function saveSubModule(Request $request)
    {
        ...
        $success = null;
        if(SubModule::find($subModuleID and $subModuleID <> null)){
            //Update
